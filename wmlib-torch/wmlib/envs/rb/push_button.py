...
class PushButton(Task):
    ...
    def init_task(self):
        ...
        self._original_pos = self.joint.get_joint_position()
    ...
    def reward(self) -> float:
        return -np.linalg.norm(self.target_button.get_position() -
                               self.robot.arm.get_tip().get_position()) + math.fabs(self.joint.get_joint_position() - self._original_pos)